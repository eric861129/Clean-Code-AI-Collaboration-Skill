...
Status: Experimental. Repository contract tests cover this profile's structure, semantic topics, metadata, and changed-module selection. No M2 pilot or M3 full run has been recorded, so it does not prove improved outcomes across TypeScript versions, runtimes, module systems, repositories, clients, or models.
